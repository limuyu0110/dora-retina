...
checkpoint = ModelCheckpoint('./working_1/trial.h5', monitor='val_loss', verbose=1, save_best_only=True, mode='min', save_weights_only=True)
...
csv_logger = CSVLogger(filename='./working_1/training_log.csv', separator=',', append=True)
    ...
    def on_epoch_end(self, epoch, logs={}):
        if epoch % self.interval == 0:
            ...
            if score >= max(self.history):
                ...
                self.model.save('./working_1/Resnet50_bestqwk.h5')
...
if __name__ == '__main__':
    ...
    callbacks_list = [checkpoint, csv_logger, reducelr, early, qwk]
    model.compile(
        loss='categorical_crossentropy',
        optimizer=Adam(),
        metrics=['accuracy']
