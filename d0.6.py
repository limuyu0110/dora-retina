...
# checkpoint = ModelCheckpoint('./d0.6/trial.h5', monitor='val_loss', verbose=1, save_best_only=True, mode='min', save_weights_only=True)
...
csv_logger = CSVLogger(filename='./d0.6/training_log.csv', separator=',', append=True)
    ...
    def on_epoch_end(self, epoch, logs={}):
        if epoch % self.interval == 0:
            ...
            if score >= max(self.history):
                ...
                self.model.save('./d0.6/Resnet50_bestqwk.h5')
